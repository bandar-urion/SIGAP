...
* **Persistencia:** Todo vive en SQLite local (control\_gastos.db).  
* **Integridad:** No se permite redundancia. Uso estricto de IDs y Foreign Keys.  
* **Gobernanza:** Reglas claras para evitar la "granulación excesiva" (micro-management).

---

# **4\. REGLAS DE NEGOCIO (GOBERNANZA)**

## **4.1. ENTIDAD: CENTROS DE COSTO (CC)**
...
* **Regla de Vinculación:** Un MP puede ser utilizado para financiar gastos de cualquier Centro de Costos (CC).  
* *Ejemplo:* MP propiedad de ‘Personal’ puede ser utilizado para pagar un gasto de ‘Mamá’.  
